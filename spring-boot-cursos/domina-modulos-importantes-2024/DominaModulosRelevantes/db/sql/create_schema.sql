...
(
    ...
    CONSTRAINT fk_customer FOREIGN KEY ( id_customer ) REFERENCES customer ( "id" ) ON DELETE NO ACTION
);
...
(
    ...
    CONSTRAINT fk_customer_r FOREIGN KEY ( customer_id ) REFERENCES customer ( "id" ) ON DELETE NO ACTION ,
...
(
    ...
    CONSTRAINT fk_customer_t FOREIGN KEY ( customer_id ) REFERENCES customer ( "id" )ON DELETE NO ACTION,
