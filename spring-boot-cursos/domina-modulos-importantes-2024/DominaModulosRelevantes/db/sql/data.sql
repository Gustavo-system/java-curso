...
insert into customer (full_name, credit_card, total_flights, total_lodgings, total_tours, phone_number) VALUES
                                                                                                                 ('Ragnar Lothbrok', '6473-9486-9372-0921', 0, 0, 0, '33-74-58-43'),
                                                                                                                 ('Walter White', '4463-3326-9980-5454', 0, 0, 0, '55-83-32-22'),
                                                                                                                 ('Wednesday Addams', '6677-5244-94572-0165', 0, 0, 0, '33-24-41-54'),
                                                                                                                 ('Khal Drogo', '6766-9484-9442-0222', 0, 0, 0, '55-78-33-11');

insert into reservation (id, date_reservation,  hotel_id, customer_id, date_start, date_end, total_days, price) VALUES
                                                                                                                    (now(), 1, 'BBMB771012HMCRR022', '2024-08-01', '2020-01-07', 7, 77.00),
                                                                                                                    (now(), 2, 'VIKI771012HMCRG093', '2024-08-01', '2020-01-07', 7, 22.00),
                                                                                                                    (now(), 3, 'VIKI771012HMCRG093', '2024-08-01', '2024-08-01', 4, 112.00),
                                                                                                                    (now(), 3, 'VIKI771012HMCRG093', '2024-08-12', '2020-01-14', 2, 74.00);

insert into ticket (id, price, fly_id, customer_id, departure_date, arrival_date, purchase_date) VALUES
                                                                                                     (330.05, 1, 'BBMB771012HMCRR022', '2024-08-01 14:00:00', '2024-08-01 16:00:00',now()),
                                                                                                     (220.33, 1, 'VIKI771012HMCRG093', '2024-08-01 14:00:00', '2024-08-01 16:00:00', now()),
                                                                                                     (320.00, 4, 'VIKI771012HMCRG093', '2024-08-01 12:00:00', '2024-08-01 15:00:00', now()),
                                                                                                     (560.77, 7, 'VIKI771012HMCRG093', '2024-08-12 20:00:00', '2020-01-14 22:00:00', now());
